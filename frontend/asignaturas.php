 ...
 * asignaturas.php
 * ---------------------------------------------------
 * Módulo ASIGNATURAS — CRUD completo conectado a BD.
        ...
        <main class="ga-main">
            ...
            <div class="card ga-card">
                ...
                <div class="card-body">
                    ...
                    <!-- Listado Premium de Asignaturas -->
                                ...
                                <div class="ga-floating-row">
                                    <div class="ga-row-content">
                                        ...
                                        <div class="ga-row-info">
                                            ...
                                            <div>
                                                ...
                                                <span class="ga-row-value"><span class="badge bg-info bg-opacity-10 text-info px-3 py-2 rounded-pill"><?php echo htmlspecialchars((string)$asignatura['creditos']); ?> CRÉDITOS</span></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ga-row-actions">
                                        <button type="button" class="btn btn-light text-primary border-0 shadow-sm"
                                                ...
                                                onclick='prepararEditarAsignatura(<?php echo json_encode($asignatura); ?>)'>
...
<!-- ===================== MODAL: Agregar / Editar asignatura ===================== -->
